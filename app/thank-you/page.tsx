...
export default function ThankYouPage() {
  return (
    <div className="min-h-screen bg-[#0A0B0E] flex flex-col items-center justify-center px-6 text-center">
      ...
      <h1 className="font-display text-display-md text-[#FAF9F7] mb-4">
        You&rsquo;re in.
      </h1>
      <p className="font-sans text-body-lg text-[#E7E5E2] max-w-[40ch] mb-3">
        K.C. will personally review your submission and be in touch within one business day to confirm your audit time.
      </p>
      <p className="font-sans text-body-md text-[#E7E5E2] max-w-[44ch] mb-3">
      ...
      <Link
        href="/"
        className="font-mono font-medium text-[0.75rem] tracking-[0.12em] uppercase text-[#857F74] hover:text-[#FAF9F7] transition-colors duration-200 no-underline"
      >
        ← Back to home
      </Link>
    </div>
