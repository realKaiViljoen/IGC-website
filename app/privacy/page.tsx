  ...
  return (
    <SectionWrapper className="bg-[#0A0B0E]">
      <div className="max-w-[720px]">
        ...
        <h1 className="font-display text-display-lg text-[#FAF9F7] mb-6">
          Privacy Policy
        </h1>
        ...
        {/* Section 1 */}
        <div className="mb-14">
          <h2 className="font-display text-display-sm text-[#FAF9F7] mb-4">
            1. Who We Are
          </h2>
          <p className="font-sans text-body-md text-[#E7E5E2] mb-4">
          ...
          <p className="font-sans text-body-md text-[#E7E5E2]">
            <strong className="text-[#FAF9F7]">Responsible Party:</strong> K.C. Viljoen (Managing Director)<br />
            <strong className="text-[#FAF9F7]">Website:</strong> https://igc-growth.com<br />
            <strong className="text-[#FAF9F7]">Contact:</strong> hello@igc-growth.com
          </p>
        </div>
        ...
        <div className="mb-14">
          ...
          <p className="font-sans text-body-md text-[#FAF9F7] mb-2 font-medium">Contact and Diagnostic Enquiry Form</p>
          <p className="font-sans text-body-md text-[#E7E5E2] mb-4">
          ...
          <ul className="list-none pl-0 mb-6 flex flex-col gap-2">
            {[
              ...
              <li key={item} className="font-sans text-body-md text-[#E7E5E2] flex items-start gap-3">
          ...
          <p className="font-sans text-body-md text-[#E7E5E2] mb-8">
            <strong className="text-[#FAF9F7]">Purpose:</strong> To assess your enquiry, respond within one business day, and determine whether our services are an appropriate fit for your clinic.
          </p>

          <p className="font-sans text-body-md text-[#FAF9F7] mb-2 font-medium">Consultation Booking (Cal.com)</p>
          <p className="font-sans text-body-md text-[#E7E5E2] mb-4">
          ...
          <p className="font-sans text-body-md text-[#E7E5E2]">
            <strong className="text-[#FAF9F7]">Purpose:</strong> To schedule and confirm a consultation call, send calendar invitations and reminders, and prepare for the diagnostic session.
          </p>
        </div>
        ...
        <div className="mb-14">
          ...
          <p className="font-sans text-body-md text-[#E7E5E2] mt-6">
        ...
        <div className="mb-14">
          ...
          <div className="border-t border-[#262A30] pt-6 mb-6">
            <p className="font-sans text-body-md text-[#FAF9F7] font-medium mb-2">Netlify, Inc.</p>
            <p className="font-sans text-body-md text-[#E7E5E2] mb-1">
              <strong className="text-[#A8A6A3]">Role:</strong> Website hosting and contact form processing.
            </p>
            <p className="font-sans text-body-md text-[#E7E5E2] mb-1">
              <strong className="text-[#A8A6A3]">Data processed:</strong> Form submission data (name, clinic name, email, phone, challenge description), server logs, and visitor metadata.
            </p>
            <p className="font-sans text-body-md text-[#E7E5E2]">
              <strong className="text-[#A8A6A3]">Privacy policy:</strong>{' '}
              <a
                href="https://www.netlify.com/privacy/"
                target="_blank"
                rel="noopener noreferrer"
                className="text-[#E7E5E2] underline underline-offset-4 hover:text-[#FAF9F7] transition-colors duration-200"
              >
                netlify.com/privacy
              </a>
            </p>
          ...
          <div className="border-t border-[#262A30] pt-6">
            <p className="font-sans text-body-md text-[#FAF9F7] font-medium mb-2">Cal.com, Inc.</p>
            <p className="font-sans text-body-md text-[#E7E5E2] mb-1">
              <strong className="text-[#A8A6A3]">Role:</strong> Appointment scheduling and calendar management.
            </p>
            <p className="font-sans text-body-md text-[#E7E5E2] mb-1">
              <strong className="text-[#A8A6A3]">Data processed:</strong> Name, email address, appointment date and time, and any notes submitted at the time of booking.
            </p>
            <p className="font-sans text-body-md text-[#E7E5E2]">
              <strong className="text-[#A8A6A3]">Privacy policy:</strong>{' '}
              <a
          ...
          <ul className="list-none pl-0 flex flex-col gap-5">
            {[
              ...
              <li key={right} className="flex flex-col gap-1">
                <span className="font-sans text-body-md text-[#FAF9F7] font-medium">{right}</span>
                <span className="font-sans text-body-md text-[#E7E5E2]">{desc}</span>
              </li>
            ))}
          </ul>
          <p className="font-sans text-body-md text-[#E7E5E2] mt-6">
        ...
        <div className="mb-14">
          ...
          <p className="font-sans text-body-md text-[#E7E5E2] mb-10">
            <strong className="text-[#FAF9F7]">K.C. Viljoen — Managing Director, Integrated Growth Consultants</strong><br />
            <a
              href="mailto:hello@igc-growth.com"
              className="text-[#E7E5E2] underline underline-offset-4 hover:text-[#FAF9F7] transition-colors duration-200"
            >
          ...
          <div className="border-t border-[#262A30] pt-6">
            ...
            <p className="font-sans text-body-md text-[#E7E5E2]">
              <strong className="text-[#FAF9F7]">The Information Regulator (South Africa)</strong><br />
        ...
        <div className="border-t border-[#262A30] pt-8">
