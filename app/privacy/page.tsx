...
export default function PrivacyPage() {
  return (
    <SectionWrapper className="bg-[#0A0C0F]">
      <div className="max-w-[720px]">
        <span className="gold-line mb-6 block" aria-hidden="true" />
        <p className="section-label mb-4">Legal</p>

        <h1 className="font-display text-display-lg text-[#FAF8F5] mb-6">
          Privacy Policy
        </h1>
        <p className="font-sans text-body-md text-[#7C7A76] mb-16">
          Effective date: April 2026
        </p>

        {/* Section 1 */}
        <div className="mb-14">
          <h2 className="font-display text-display-sm text-[#FAF8F5] mb-4">
            1. Who We Are
          </h2>
          <p className="font-sans text-body-md text-[#E7E4E0] mb-4">
          ...
          <p className="font-sans text-body-md text-[#E7E4E0]">
            <strong className="text-[#FAF8F5]">Responsible Party:</strong> K.C. Viljoen (Managing Director)<br />
            <strong className="text-[#FAF8F5]">Website:</strong> https://igc-growth.com<br />
            <strong className="text-[#FAF8F5]">Contact:</strong> hello@igc-growth.com
          </p>
        </div>
        ...
        <div className="mb-14">
          ...
          <p className="font-sans text-body-md text-[#E7E4E0] mb-6">
          ...
          <p className="font-sans text-body-md text-[#FAF8F5] mb-2 font-medium">Contact and Diagnostic Enquiry Form</p>
          <p className="font-sans text-body-md text-[#E7E4E0] mb-4">
          ...
          <ul className="list-none pl-0 mb-6 flex flex-col gap-2">
            {[
              ...
              <li key={item} className="font-sans text-body-md text-[#E7E4E0] flex items-start gap-3">
                <span className="text-[#7C7A76] mt-1 shrink-0">—</span>
                {item}
              </li>
            ))}
          </ul>
          <p className="font-sans text-body-md text-[#E7E4E0] mb-8">
            <strong className="text-[#FAF8F5]">Purpose:</strong> To assess your enquiry, respond within one business day, and determine whether our services are an appropriate fit for your clinic.
          </p>

          <p className="font-sans text-body-md text-[#FAF8F5] mb-2 font-medium">Consultation Booking (Cal.com)</p>
          <p className="font-sans text-body-md text-[#E7E4E0] mb-4">
          ...
          <p className="font-sans text-body-md text-[#E7E4E0]">
            <strong className="text-[#FAF8F5]">Purpose:</strong> To schedule and confirm a consultation call, send calendar invitations and reminders, and prepare for the diagnostic session.
          </p>
        </div>
        ...
        <div className="mb-14">
          ...
          <p className="font-sans text-body-md text-[#E7E4E0] mt-6">
        ...
        <div className="mb-14">
          ...
          <div className="border-t border-[#20242A] pt-6 mb-6">
            <p className="font-sans text-body-md text-[#FAF8F5] font-medium mb-2">Netlify, Inc.</p>
            <p className="font-sans text-body-md text-[#E7E4E0] mb-1">
              <strong className="text-[#C3C0BB]">Role:</strong> Website hosting and contact form processing.
            </p>
            <p className="font-sans text-body-md text-[#E7E4E0] mb-1">
              <strong className="text-[#C3C0BB]">Data processed:</strong> Form submission data (name, clinic name, email, phone, challenge description), server logs, and visitor metadata.
            </p>
            <p className="font-sans text-body-md text-[#E7E4E0]">
              <strong className="text-[#C3C0BB]">Privacy policy:</strong>{' '}
              <a
                href="https://www.netlify.com/privacy/"
                target="_blank"
                rel="noopener noreferrer"
                className="text-[#E7E4E0] underline underline-offset-4 hover:text-[#FAF8F5] transition-colors duration-200"
              >
                netlify.com/privacy
              </a>
            </p>
          ...
          <div className="border-t border-[#20242A] pt-6">
            <p className="font-sans text-body-md text-[#FAF8F5] font-medium mb-2">Cal.com, Inc.</p>
            <p className="font-sans text-body-md text-[#E7E4E0] mb-1">
              <strong className="text-[#C3C0BB]">Role:</strong> Appointment scheduling and calendar management.
            </p>
            <p className="font-sans text-body-md text-[#E7E4E0] mb-1">
              <strong className="text-[#C3C0BB]">Data processed:</strong> Name, email address, appointment date and time, and any notes submitted at the time of booking.
            </p>
            <p className="font-sans text-body-md text-[#E7E4E0]">
              <strong className="text-[#C3C0BB]">Privacy policy:</strong>{' '}
              <a
          ...
          <ul className="list-none pl-0 flex flex-col gap-5">
            {[
              ...
              <li key={right} className="flex flex-col gap-1">
                <span className="font-sans text-body-md text-[#FAF8F5] font-medium">{right}</span>
                <span className="font-sans text-body-md text-[#E7E4E0]">{desc}</span>
              </li>
            ))}
          </ul>
          <p className="font-sans text-body-md text-[#E7E4E0] mt-6">
        ...
        <div className="mb-14">
          ...
          <p className="font-sans text-body-md text-[#E7E4E0] mb-10">
            <strong className="text-[#FAF8F5]">K.C. Viljoen — Managing Director, Integrated Growth Consultants</strong><br />
            <a
              href="mailto:hello@igc-growth.com"
              className="text-[#E7E4E0] underline underline-offset-4 hover:text-[#FAF8F5] transition-colors duration-200"
            >
          ...
          <div className="border-t border-[#20242A] pt-6">
            ...
            <p className="font-sans text-body-md text-[#E7E4E0]">
              <strong className="text-[#FAF8F5]">The Information Regulator (South Africa)</strong><br />
        ...
        <div className="border-t border-[#20242A] pt-8">
          <p className="font-mono text-[11px] tracking-[0.12em] uppercase text-[#7C7A76]">
