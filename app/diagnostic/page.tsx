    ...
    <div className="min-h-screen bg-[#0A0C0F]">
      ...
      <div className="w-full px-6 md:px-10 lg:px-16 pt-32 pb-16 md:pb-20">
        <div className="max-w-site mx-auto">
          ...
          <h1 className="font-display text-display-lg text-[#FAF8F5] max-w-[22ch]">
        ...
        <div className="max-w-site mx-auto">
          <div className="flex flex-col lg:flex-row gap-8 lg:gap-12 items-start">
            ...
            <aside className="w-full lg:w-[300px] shrink-0 lg:sticky lg:top-24">
              <div className="border border-[#20242A] bg-[#060709] p-6 rounded-md">
                ...
                {/* Name + title */}
                <h2 className="font-display text-display-sm text-[#FAF8F5] leading-tight mb-1">
                  K.C. Viljoen
                </h2>
                <p className="font-mono text-[11px] tracking-[0.14em] uppercase text-[#C3C0BB] mb-4">
                  Growth Infrastructure Operator
                </p>

                {/* Divider */}
                <div className="border-t border-[#20242A] my-4" />
                ...
                <ul className="flex flex-col gap-3">
                  {[
                    ...
                    <li key={item} className="flex items-start gap-2.5">
                      ...
                      <span className="font-sans text-base text-[#E7E4E0] leading-relaxed">{item}</span>
                    </li>
                  ))}
                </ul>
                ...
                <p className="font-mono text-[11px] tracking-[0.14em] uppercase text-[#C3C0BB] mb-3">
                ...
                <ul className="flex flex-col gap-2.5">
                  {[
                    ...
                    <li key={item} className="flex items-start gap-2.5">
                      <span className="font-mono text-[#C78B28] text-[10px] mt-0.5 shrink-0">→</span>
                      <span className="font-sans text-base text-[#E7E4E0] leading-relaxed">{item}</span>
                    </li>
                  ))}
                </ul>
                ...
                {/* LinkedIn link */}
                <div className="border-t border-[#20242A] mt-4 pt-4">
                  <a
                    href="https://linkedin.com/in/kai-viljoen"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-flex items-center gap-2 font-mono text-[11px] tracking-[0.12em] uppercase text-[#C3C0BB] hover:text-[#FAF8F5] transition-colors duration-200"
                  >
            ...
            <div className="flex-1 w-full min-w-0 min-h-[700px]">
              <CalEmbed />
              <p className="font-mono text-[11px] tracking-[0.12em] uppercase text-[#7C7A76] mt-3">
                Prefer email? hello@igc-growth.com
              </p>
            </div>
