    ...
    <div className="min-h-screen bg-[#0A0B0E]">
      ...
      <div className="w-full px-6 md:px-10 lg:px-16 pt-32 pb-16 md:pb-20">
        <div className="max-w-site mx-auto">
          ...
          <h1 className="font-display text-display-lg text-[#FAF9F7] max-w-[22ch]">
        ...
        <div className="max-w-site mx-auto">
          <div className="flex flex-col lg:flex-row gap-8 lg:gap-12 items-start">
            ...
            <aside className="w-full lg:w-[300px] shrink-0 lg:sticky lg:top-24">
              <div className="border border-[#262A30] bg-[#070809] p-6 rounded-md">
                ...
                {/* Name + title */}
                <h2 className="font-display text-display-sm text-[#FAF9F7] leading-tight mb-1">
                  K.C. Viljoen
                </h2>
                <p className="font-mono text-[11px] tracking-[0.14em] uppercase text-[#A8A6A3] mb-4">
                  Growth Infrastructure Operator
                </p>

                {/* Divider */}
                <div className="border-t border-[#262A30] my-4" />
                ...
                <ul className="flex flex-col gap-3">
                  {[
                    ...
                    <li key={item} className="flex items-start gap-2.5">
                      ...
                      <span className="font-sans text-base text-[#E7E5E2] leading-relaxed">{item}</span>
                    </li>
                  ))}
                </ul>
                ...
                <p className="font-mono text-[11px] tracking-[0.14em] uppercase text-[#A8A6A3] mb-3">
                ...
                {/* LinkedIn link */}
                <div className="border-t border-[#262A30] mt-4 pt-4">
                  <a
                    href="https://linkedin.com/in/kai-viljoen"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-flex items-center gap-2 font-mono text-[11px] tracking-[0.12em] uppercase text-[#A8A6A3] hover:text-[#FAF9F7] transition-colors duration-200"
                  >
