  ...
  return (
    <>
      ...
      <SectionWrapper className="bg-[#0A0C0F]">
        ...
        <h1 className="font-display text-display-lg text-[#FAF8F5] max-w-[18ch] mb-6">
          We only publish what we can prove.
        </h1>

        <p className="font-sans text-body-lg text-[#E7E4E0] max-w-prose mb-10">
      ...
      <SectionWrapper className="bg-[#0F1216]">
        ...
        <h2 className="font-display text-display-md text-[#FAF8F5] max-w-[20ch] mb-10">
          Four numbers. Everything else is noise.
        </h2>

        <div className="flex flex-col divide-y divide-[#20242A]">
          {metrics.map((item) => (
            <div key={item.metric} className="py-6 flex flex-col md:flex-row md:gap-12">
              <h3 className="font-sans font-medium text-[#FAF8F5] text-base md:w-64 shrink-0 mb-2 md:mb-0">
                {item.metric}
              </h3>
              <p className="font-sans text-body-md text-[#E7E4E0]">{item.why}</p>
            </div>
          ))}
        </div>
      </SectionWrapper>
      ...
      <SectionWrapper className="bg-[#0A0C0F]">
        ...
        <div className="flex flex-col md:flex-row md:items-start gap-8 max-w-[800px]">
          <div className="border border-[#20242A] p-6 flex-1">
            <p className="font-mono text-[12px] tracking-[0.12em] uppercase text-[#C3C0BB] mb-3">Current Status</p>
            <p className="font-display text-display-md text-[#FAF8F5] leading-tight mb-2">In Progress</p>
            <p className="font-sans text-body-md text-[#E7E4E0]">4 agencies actively running the system. Deployment began Q1 2026.</p>
          </div>

          <div className="border border-[#20242A] p-6 flex-1">
            <p className="font-mono text-[12px] tracking-[0.12em] uppercase text-[#C3C0BB] mb-3">Results Published</p>
            <p className="font-display text-display-md text-[#FAF8F5] leading-tight mb-2">Q3 2026</p>
            <p className="font-sans text-body-md text-[#E7E4E0]">First verified case studies published after full 90-day deployment cycle completes.</p>
          </div>
        </div>
      </SectionWrapper>
      ...
      <SectionWrapper className="bg-[#0F1216]">
        <div className="flex flex-col items-start gap-4">
          <p className="font-sans text-body-lg text-[#FAF8F5] max-w-prose">
            Want to be part of Cohort 2?
          </p>
          <p className="font-sans text-body-md text-[#E7E4E0] max-w-prose mb-4">
