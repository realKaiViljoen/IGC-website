...
const steps = [
  {
    ...
    icon: (
      <svg className="w-5 h-5 text-[#C78B28]/60" viewBox="0 0 20 20" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
  ...
  return (
    <SectionWrapper id="how-it-works" className="bg-[#101215] text-[#FAF9F7] overflow-hidden">
      <div ref={ref}>
        ...
        >
          <div
            className="hidden md:block absolute top-[1.5rem] left-[2rem] right-[2rem] h-px bg-gradient-to-r from-[#C78B28]/0 via-[#C78B28]/20 to-[#C78B28]/0"
            aria-hidden="true"
          />
          {steps.map((step) => (
            <motion.div
            ...
            >
              ...
              {step.subtitle && (
                <p className="relative font-mono text-[11px] tracking-[0.12em] uppercase text-[#C78B28]/70 mb-4 z-10">
                  {step.subtitle}
                </p>
              )}
